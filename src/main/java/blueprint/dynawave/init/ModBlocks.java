...
import blueprint.dynawave.block.JumpBlock;
...
public class ModBlocks {
    ...
    public static final Block JUMP_BLOCK = register(
            new JumpBlock(AbstractBlock.Settings.create().sounds(BlockSoundGroup.SLIME)),
            "jump_block", true
    );
